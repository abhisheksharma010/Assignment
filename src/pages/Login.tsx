...
function Login() {
  ...
  const handleGoogleLogin = () => {
    ...
    window.location.href =
      "https://hiring.reachinbox.xyz/api/v1/auth/google-login?redirect_to=https://assignment-azure-zeta.vercel.app/";
  };
  ...
  return (
    <div>
      ...
      <div className="bg-black text-white w-screen h-screen flex flex-col justify-center items-center">
        <div className="bg-[#111214] text-center space-y-10 px-10 rounded-2xl border border-[#343A40]">
          <div className="">
